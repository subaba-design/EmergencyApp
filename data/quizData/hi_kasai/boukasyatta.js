const boukasyatta_hi_kasai_kyouyoubu = {
    ...
    flow: [
        ...
        ['傷病者確認の無線を入れたら？', '無線「シャッター降下確認、お客様広報実施します」<br/>お客様広報を実施し、設備チームのシャッター巻き上げ完了を待つ'],
...
const boukasyatta_hi_kasai_tenpo_hanpei = {
    ...
    flow: [
        ...
        ['火災か非火災かの確認でのポイントは？', '視覚、嗅覚、聴覚を働かせる<br/>また、その場で取れた情報は逐次防災センターに無線報告する'],
        ['非火災確認の無線を入れたら？', '傷病者の確認<br/>傷病者がいたら、無線「傷病者がおられます！確認に入ります！」<span class="strong-red">傷病者対応に移行</span><br/>傷病者がいなかったら、無線「周辺傷病者有りません」'],
        ['傷病者確認の無線を入れたら？', '無線「シャッター降下確認、<span class="strong-red">半閉状態で中のお客様は出られる状況です</span>。お客様広報実施します」<br/>お客様広報を実施し、設備チームのシャッター巻き上げ完了を待つ'],
        ['お客様広報を実施し、設備チームのシャッター巻き上げが完了したら？', '無線「設備チームにてシャッター巻き上げ完了し現場対応終了です」']
    ],
...
const boukasyatta_hi_kasai_tenpo_zenpei = {
    ...
    flow: [
        ...
        ['火災か非火災かの確認でのポイントは？', '視覚、嗅覚、聴覚を働かせる<br/>また、その場で取れた情報は逐次防災センターに無線報告する'],
        ['非火災確認の無線を入れたら？', '傷病者の確認<br/>傷病者がいたら、無線「傷病者がおられます！確認に入ります！」<span class="strong-red">傷病者対応に移行</span><br/>傷病者がいなかったら、無線「周辺傷病者有りません」'],
        ['傷病者確認の無線を入れたら？', '無線「シャッター降下確認、<span class="strong-red">全閉状態で中のお客様は出られない状況です</span>。<br/>店舗前に警備1名を残し店舗バック通路から入って店内状況を確認報告します」<span class="strong-red">二手に分かれる</span>'],
